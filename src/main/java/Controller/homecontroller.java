...
public class homecontroller {
    ...
    public String index(Model model, HttpServletRequest req) {
        model.addAttribute("registerpath", "/ahihi/register");
        return "register";
    ...
    public String registerteacher(Model model, HttpServletRequest request) {
        model.addAttribute("registerpath", "/ahihi/registerteacher");
        return "register";
    }
            ...
            if (currentsubclass != null) {
                ...
                if (assign_classes != null) {
                    ...
                    updatescoreform = "<p>UPDATE SCORE</p>"
                            ...
                            + "<form action=\"/ahihi/updatescore\" method=\"post\">"
                            + "<p>studentID</p><br>"
    ...
    public String registersubjectteacherform(Model model) {
        ...
        if (subjectlist.size() == 0) {
            ...
            for (subject sub : subjectlist) {
                form = "<form action=\"/ahihi/openclass\" method=\"post\">\n"
        ...
        if (subclasses != null) {
            ...
            String form = "";
            for (subclass subclass : subclasses) {
                form = "<form action=\"/ahihi/deleteclassteacher\" method=\"post\">\n"
    ...
    public String registerclassform(Model model) {
        ...
        if (subclasses != null) {
            ...
            for (subclass sub : subclasses) {
                if (subclassid.get(sub.getsubject().getid()) != null)
                    continue;
                form = "<form action=\"/ahihi/registerclass\" method=\"post\">\n"
        ...
        if (assign_classes != null) {
            ...
            String form = "";
            for (assign_class assign_class : assign_classes) {
                form = "<form action=\"/ahihi/deleteclasstudent\" method=\"post\">\n"
